...
public class ServiceConfiguration implements PulsarConfiguration {
    ...
    // Once broker reaches maxUnackedMessagesPerBroker, it blocks subscriptions which has unacked messages higher than
    // this percentage limit to block higher unack-msg subscriptions and limit has to be > 0 
