...
public class ManagedLedgerConfig {
    ...
    /**
     * Max backlog gap between backlogged cursors while caching to avoid caching entry which can be invalidated before other backlog
     * cursor can reuse it from cache.
     *
     * @return
     */
