...
import org.apache.pulsar.schema.Schemas.PersonFour;
 ...
 */
public class PartitionedTopicSchemaTest2 extends MockedPulsarServiceBaseTest {
    ...
    @Test
    public void testV1TopicSchema() throws Exception {
        String topicName = "persistent://public/test/ns/t1";

        @Cleanup
        Producer<Schemas.PersonFour> producer = pulsarClient.newProducer(AvroSchema.of(PersonFour.class))
                .topic(topicName)
                .enableBatching(false)
                .create();
        
        Consumer<Schemas.PersonFour> consumer = pulsarClient.newConsumer(AvroSchema.of(PersonFour.class))
                .topic(topicName)
        ...
        for (int i = 0; i < MESSAGE_COUNT_PER_PARTITION; i++) {
            ...
            Schemas.PersonFour val = message.getValue();
