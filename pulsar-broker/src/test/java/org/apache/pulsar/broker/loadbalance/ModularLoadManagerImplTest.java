...
public class ModularLoadManagerImplTest {
    ...
    public void testAntiAffinityNamespaceFilteringWithDomain() throws Exception {
        ...
        addNamespaceToBroker(brokerToNamespaceToBundleRange, "brokerName-0", namespace + "0", assignedNamespace);
        candidate.addAll(brokers);
        ...
        addNamespaceToBroker(brokerToNamespaceToBundleRange, "brokerName-2", namespace + "1", assignedNamespace);
        candidate.addAll(brokers);
        ...
        addNamespaceToBroker(brokerToNamespaceToBundleRange, "brokerName-1", namespace + "2", assignedNamespace);
        candidate.addAll(brokers);
        ...
        addNamespaceToBroker(brokerToNamespaceToBundleRange, "brokerName-3", namespace + "3", assignedNamespace);
        candidate.addAll(brokers);
    ...
    public void testAntiAffinityNamespaceFilteringWithoutDomain() throws Exception {
        ...
        addNamespaceToBroker(brokerToNamespaceToBundleRange, "broker-0", namespace + "0", assignedNamespace);
        candidate.addAll(brokers);
        assignedNamespace = namespace + "1" + bundle;
        ...
        addNamespaceToBroker(brokerToNamespaceToBundleRange, "broker-1", namespace + "1", assignedNamespace);
        candidate.addAll(brokers);
        ...
        addNamespaceToBroker(brokerToNamespaceToBundleRange, "broker-2", namespace + "2", assignedNamespace);
        candidate.addAll(brokers);
