...
public class SimpleProducerConsumerStatTest extends ProducerConsumerBase {
    ...
    public void testTopicStatsAndInternal(boolean isPersistentTopic) throws Exception {
        ...
        TopicStatsInfo statsInfo = producer.getTopicStatsProvider().getStats().get();
        ...
        TopicInternalStatsInfo internalStatsInfo = producer.getTopicStatsProvider().getInternalStats().get();
        ...
        statsInfo = consumer.getTopicStatsProvider().getStats().get();
        assertEquals(statsInfo.getPartitions().size(), 1);
        assertEquals(statsInfo.getPartitions().get(topicName).getMsgInCounter(), numMessages);
    
        
        internalStatsInfo = consumer.getTopicStatsProvider().getInternalStats().get();
        assertEquals(internalStatsInfo.getPartitions().size(), 1);
        assertEquals(internalStatsInfo.getPartitions().get(topicName).entriesAddedCounter, numMessages);
    ...
    public void testFailedTopicStatsAndInternal() throws Exception {
        ...
        // validate producer topic-stats
        try {
            producer.getTopicStatsProvider().getStats().get();
        ...
        try {
            producer.getTopicStatsProvider().getInternalStats().get();
            fail("stats call should have failed");
        } catch (ExecutionException e) {
            assertTrue(e.getCause() instanceof PulsarClientException);
        }
        ...
        // validate consumer topic-stats
        try {
            consumer.getTopicStatsProvider().getStats().get();
            fail("stats call should have failed");
        } catch (ExecutionException e) {
            assertTrue(e.getCause() instanceof PulsarClientException);
        }
        ...
        try {
            consumer.getTopicStatsProvider().getInternalStats().get();
            fail("stats call should have failed");
        } catch (ExecutionException e) {
            assertTrue(e.getCause() instanceof PulsarClientException);
        }
