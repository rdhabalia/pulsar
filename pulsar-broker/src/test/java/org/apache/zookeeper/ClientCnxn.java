...
import com.yahoo.pulsar.broker.zookeeper.aspectj.ClientCnxnAspect;
...
public class ClientCnxn {
    ...
    class EventThread extends ZooKeeperThread {
       ...
       private void processEvent(Object event) {
          try {
              ClientCnxnAspect aspect = new ClientCnxnAspect();
              aspect.timedProcessEvent(new ProceedingJoinPoint() {
                ...
                @Override
                public Object proceed(Object[] paramArrayOfObject) throws Throwable {
                    // TODO Auto-generated method stub
                    return null;
                }
