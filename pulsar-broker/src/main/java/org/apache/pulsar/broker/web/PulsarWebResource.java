...
public abstract class PulsarWebResource {
    ...
    protected List<String> getListOfNamespaces(String property) throws Exception {
        ...
        for (String clusterOrNamespace : clusterResources().getChildren(path(POLICIES, property))) {
            // Then get the list of namespaces
            final List<String> children = clusterResources().getChildren(path(POLICIES, property, clusterOrNamespace));
            if (children == null || children.isEmpty()) {
