...
/**
 */
public class PersistentMessagePredicateRunner implements FindEntryCallback {
    ...
    private static final AtomicIntegerFieldUpdater<PersistentMessagePredicateRunner>
            expirationCheckInProgressUpdater = AtomicIntegerFieldUpdater
            .newUpdater(PersistentMessagePredicateRunner.class, "expirationCheckInProgress");

    public PersistentMessagePredicateRunner(String topicName, String subscriptionName, ManagedCursor cursor,
    ...
    private static final Logger log = LoggerFactory.getLogger(PersistentMessagePredicateRunner.class);
