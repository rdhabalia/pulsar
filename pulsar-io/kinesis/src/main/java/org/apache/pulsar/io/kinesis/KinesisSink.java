...
public class KinesisSink implements Sink<byte[]> {
    ...
    public void write(RecordContext inputRecordContext, byte[] value) throws Exception {
        System.out.println("writting record for: "+(count++));
    ...
    public void open(Map<String, Object> config) throws Exception {
        ...
        kinesisConfig.setThreadPoolSize(10);// TODO: fix it..
        kinesisConfig.setCollectionMaxCount(1); // TODO: need ordering guarantee: take it from property
    ...
    private static final class ProducerSendCallback implements FutureCallback<UserRecordResult> {
        ...
        public void onFailure(Throwable exception) {
            ...
            System.out.println("failed published");
            recycle();
        }
    }
