...
public interface ConsumerBuilder<T> extends Cloneable {
     ...
     * the outstanding unchunked-messages by silently acking or asking broker to redeliver later by marking it unacked. This behavior can be
     * controlled by configuration: @autoAckOldestChunkedMessageOnQueueFull
     * 
     * @default 1000
     * 
     ...
     * Buffering large number of outstanding uncompleted chunked messages can create memory pressure and it can be
     * guarded by providing this @maxPendingChuckedMessage threshold. Once, consumer reaches this threshold, it drops
     * the outstanding unchunked-messages by silently acking if autoAckOldestChunkedMessageOnQueueFull is true else it marks them for redelivery.
     * 
     * @default false
     * 
