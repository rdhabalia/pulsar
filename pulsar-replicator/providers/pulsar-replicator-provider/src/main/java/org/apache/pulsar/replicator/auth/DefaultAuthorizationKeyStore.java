...
/**
 * Simple Default AuthParamStore which stores auth-data into
 * replicator-properties and retrieves from the same replicator-properties which
 * is part of the namespace-policies.
 * 
 *
 */
